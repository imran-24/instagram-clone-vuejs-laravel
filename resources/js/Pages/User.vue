    ...
    <MainLayout>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] md:pl-20 px-4 w-[100vw]">
            <div class="flex items-center md:justify-between">
                ...
                <label for="fileUser">
                    <div class="md:w-[200px] md:h-[200px] h-[100px] w-[100px]">
                    <img
                        class="rounded-full object-fit w-full h-full cursor-pointer"
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        <div class="md:mr-6 mr-3 rounded-lg text-[22px]">Imran syam</div>
                    ...
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            <div class="mr-6">
                                <span class="font-extrabold">12</span>  posts
                            </div>
                            <div class="mr-6">
...
import ContentOverlay from '../Components/ConventOverlay.vue'
