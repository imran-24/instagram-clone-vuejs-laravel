...
<template>
    ...
    <MainLayout>
        <div class="mx-auto lg:pl-0 md:pl-[80px] pl-0">
            ...
            >
                <Slide v-for="slide in 10" :key="slide">
                    <Link href="/" class="relative mx-auto text-center mt-4 px-2 cursor-pointer">
                        ...
                        <div class="text-xs mt-2 w-[60px] truncate text-ellipsis overflow-hidden">Imran Syam</div>
                    </Link>
                </Slide>
            ...
            <div id="Posts" class="px-4 max-w-[600px] mx-auto mt-10" v-for="post in 2" :key="post">
                <div class="flex items-center justify-between py-2">
                    <div class="flex items-center">
                        <Link href="/" class="flex items-center">
                            <img class="rounded-full w-[38px] h-[38px]" src="https://picsum.photos/id/54/300/320" />
                            <div class="ml-4 font-extrabold text-[15px]">Imran Syam</div>
                        </Link>
                    ...
                    <DotsHorizontalVue class="cursor-pointer" :size="27"/>
                </div>
                ...
                <div class="text-black font-extrabold py-1">12 likes</div>
                <div>
                    <span class="text-black font-extrabold">Imran syam</span>
